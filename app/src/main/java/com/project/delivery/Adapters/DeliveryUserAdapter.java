...
public class DeliveryUserAdapter extends RecyclerView.Adapter<DeliveryUserAdapter.DeliveryViewHolder> {
    ...
    @NonNull
    @Override
    public DeliveryUserAdapter.DeliveryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.delivery_card_user, parent,false);
        return new DeliveryUserAdapter.DeliveryViewHolder(v);

    }

    @Override
    public void onBindViewHolder(@NonNull DeliveryUserAdapter.DeliveryViewHolder holder, int position) {
