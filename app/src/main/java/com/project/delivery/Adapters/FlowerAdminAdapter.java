...
public class FlowerAdminAdapter extends RecyclerView.Adapter<FlowerAdminAdapter.FlowerViewHolder> {
    ...
    public FlowerAdminAdapter(Context context, ArrayList<flower> flowerList) {
    ...
    public FlowerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.flower_card_admin, parent,false);
    ...
    public void onBindViewHolder(@NonNull FlowerViewHolder holder, int position) {
        ...
        holder.cost.setText(flowers.getCost());
